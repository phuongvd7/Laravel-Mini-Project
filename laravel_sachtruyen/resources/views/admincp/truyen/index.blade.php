                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            {{--  du lieu cua danh muc nam trong ham danhmucTruyen => chi can goi ra --}}
                            <td>
                            ...
                            <td>
                                ...
                                <form action = "{{route('truyen.destroy',[$truyen->id])}}" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <button onclick="return confirm(' Bạn có chắc chắn muốn xóa truyện này không? ')" class = "btn btn-danger">Delete </button>
                                </form>
                            </td>
                          </tr>
                          @endforeach
