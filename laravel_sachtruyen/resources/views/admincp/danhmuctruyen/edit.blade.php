                ...
                <div class="card-body">
                    ...
                    <form method="POST" action = "{{route('danhmuc.update',[$danhmuc->id])}}">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" onkeyup="ChangeToSlug();" name="tendanhmuc" value="{{$danhmuc->tendanhmuc}}" id="slug" aria-describedby="emailHelp" placeholder="Tên danh mục">
                        </div>
                        <div class="form-group">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" name="mota" value="{{$danhmuc->mota}}" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Mô tả danh mục">
                          </div>
                          <div>
