                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                      ...
                      <form autocomplete = "off" class="form-inline my-2 my-lg-0" action = "{{url('tim-kiem')}}" method = "GET">
                        ...
                        <div id = "search_ajax" class="form-inline my-2 my-lg-0" ></div>
                  ...
                  @yield('content')
                    ...
                    <footer class="text-muted py-5">
                      <div class="container">
                        ...
                        <p class="mb-1">Sách tổng hơp và sửa lỗi chính tả các tác phẩm sách, truyện hiện có trên mạng internet, nếu bạn có bản quyền thương mại thì liên hệ admin</p>
