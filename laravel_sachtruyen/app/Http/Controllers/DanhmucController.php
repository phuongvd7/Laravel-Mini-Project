...
class DanhmucController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->back()->with('status','Thêm danh mục thành công'); // tra ve trang cu da gui du lieu
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        [
            ...
            'tendanhmuc.required' => 'Tên danh mục phải có nhé',
            'slug_tendanhmuc.required' => 'Slug danh mục phải có nhé',
            'mota.required' => 'Mô tả danh mục phải có nhé',
        ] 
        );
    ...
    public function destroy($id)
    {
        ...
        return redirect()->back()->with('status','Xóa danh mục thành công'); // tra ve trang cu da gui du lieu
    }
}
